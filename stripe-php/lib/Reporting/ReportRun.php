 ...
 * @property bool $livemode <code>true</code> if the eport is un on live mode data and <code>false</code> if it is un on test mode data.
 * @poperty \Stripe\StripeObject $parameters
 * @p2ŞàÊäèò@æèäÒÜÎ@HäÊàŞäè¾èòàÊ@¨ĞÊ@’ˆ@ŞÌ@èĞÊ@xÂ@ĞäÊÌzDĞèèàæt^^æèäÒàÊ\ÆŞÚ^ÈŞÆæ^äÊàŞäèæ^äÊàŞäèZèòàÊæD|äÊàŞäè@èòàÊx^Â|@èŞ@$êÜX@æêÆĞ@Âæ@xÆŞÈÊ|LâêŞèvÄÂØÂÜÆÊ\æêÚÚÂäò\bLâêŞèvx^ÆŞÈÊ|\@T@€à¤operty null|\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).

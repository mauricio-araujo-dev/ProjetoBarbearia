...
echo "<tr><td>" . $row["Id"] . "</td><td>" . $row["Nome"] . "</td><td>" . $row["Username"] . "</td><td>" . $row["Email"] . "</td><td>" . $row["Cpf"] . "</td><td>" . $row["Telefone"] . "</td><td>" . $row["Endereco"] . "</td><td>" . $row["Senha"] . "</td><td>" . $row["Acesso"] . "</td><td>" . $row["Status"] . "</td>";
